...
<html class="loading">
  ...
  <div class="content-body">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>𝒮☯𝐼𝐿𝑀𝒜𝒩 𝒮𝒦 𝐵𝒜𝒮𝐸𝒟 𝑅𝒜𝒯𝐸 𝐿𝐼𝑀𝐼𝒯 𝐵𝒴𝒫𝒜𝒮𝒮+𝒜𝒫𝐼𝒮 𝒞𝒞 𝒞𝐻𝐸𝒞𝒦𝐸𝑅</strong></h4>
					...
					<textarea rows="1"class="form-control text-center" style="width: 30%; float: right margin-bottom: 5px;" id="cst" placeholder="ᴄᴜꜱᴛᴏᴍ ᴀᴍᴏᴜɴᴛ ᴏʀ ʟᴇᴀᴠᴇ ɪᴛ ʙʟᴀɴᴋ"></textarea></br>
    ...
    <option </option>
               ...
               <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur5CCN.php">CCN CHARGE: €5</option>

                <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur1CVV.php">CVV CHARGE: €1</option>

                <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur5CVV.php">CVV CHARGE: €5</option>

        <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api1.php">api_1_non_sk</option>
        
        <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api2.php">api_2_non_sk</option>  

        <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api3.php">api_3_non_sk</option> 

        <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api4.php">api_4_non_sk</option>  

        <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api5.php">api_5_non_sk</option>
...
<footer>
  <p> <b><div class=text-danger>𝐸𝒟𝐼𝒯 𝐵𝒴 𝒮𝒪𝐼𝐿𝑀𝒜𝒩0_0</b></a></div></p>
</footer>
<style>
